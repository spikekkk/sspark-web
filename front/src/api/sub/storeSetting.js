...
export function fetchPersonList(data) {
  return request({
    url: '/sub/storeSetting/queryPersonList',
    method: 'post',
    data: data
  })
}
...
export function updatePersonFun(data) {
  return request({
    url: '/sub/storeSetting/updatePersonInfo',
    method: 'post',
    data: data
  })
}
...
// 门店设置---获取打印信息
export function getPrintSetup(data) {
  return request({
    url: '/sub/storeSetting/getPrintSetup',
    method: 'post',
    data: data
  })
}
// 门店设置---更新打印信息
export function updatePrintSetup(data) {
  return request({
    url: '/sub/storeSetting/updatePrintSetup',
    method: 'post',
    data: data
  })
}
