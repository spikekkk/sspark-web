...
module.exports = class extends Base {
  ...
  async queryMemberListAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/customer/queryCustomer',
      reqData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  async queryMemberCardListAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/customer/queryCustomerConsumerCard',
      reqData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  async queryOrderListAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/customer/queryCustomerPurchase',
      reqData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  async queryCustomerVerifyAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/customer/queryCustomerVerify',
      reqData
    ).then(res => res.json());
    this.body = json;
  }
