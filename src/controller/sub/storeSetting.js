...
module.exports = class extends Base {
  ...
  async cashierOpenQrAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/shouyinbao/createShouYinQrImg',
      postData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  async cashierOpenSureAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/shouyinbao/addShouYinBao',
      postData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  async cashierEditSureAction() {
    ...
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/shouyinbao/updateShouYinBao',
      postData
    ).then(res => res.json());
    this.body = json;
  }
  ...
  // 门店设置---打印设置查询
  async getPrintSetupAction() {
    const postData = this.ctx.request.body.post || {};
    console.log('=============获取打印 postData =======', postData);
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/print/getPrintSetup',
      postData
    ).then(res => res.json());
    this.body = json;
  }
  // 门店设置---打印设置更新
  async updatePrintSetupAction() {
    const postData = this.ctx.request.body.post || {};
    console.log('=============更新打印 postData =======', postData);
    const json = await this.postJson(
      edenServerEureka,
      baseUrl + '/shop/print/updatePrintSetup',
      postData
    ).then(res => res.json());
    this.body = json;
  }
